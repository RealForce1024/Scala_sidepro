...
/**
  ...
  */
//private[ch06] class Person(var id: Int = 0, var age: Int = 0) {

  //包访问权限，所有子包可以访问，其他包则无法访问
  private[ch06] class Person private(var id: Int = 0, var age: Int = 0) {
    //第二个private 构造器私有 只能在自己的伴生对象初始化
